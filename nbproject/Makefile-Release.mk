...
${OBJECTDIR}/libyaxl/sockets/InputStream.o: libyaxl/sockets/InputStream.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Isrc -std=c++11 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/libyaxl/sockets/InputStream.o libyaxl/sockets/InputStream.cpp

${OBJECTDIR}/libyaxl/concurrency/Condition.o: libyaxl/concurrency/Condition.cpp 
	${MKDIR} -p ${OBJECTDIR}/libyaxl/concurrency
	${RM} $@.d
	$(COMPILE.cc) -O2 -Isrc -std=c++11 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/libyaxl/concurrency/Condition.o libyaxl/concurrency/Condition.cpp

${OBJECTDIR}/libyaxl/sockets/Socket.o: libyaxl/sockets/Socket.cpp 
	${MKDIR} -p ${OBJECTDIR}/libyaxl/sockets
	${RM} $@.d
	$(COMPILE.cc) -O2 -Isrc -std=c++11 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/libyaxl/sockets/Socket.o libyaxl/sockets/Socket.cpp
...
${OBJECTDIR}/libyaxl/concurrency/CachedCondition.o: libyaxl/concurrency/CachedCondition.cpp 
	${MKDIR} -p ${OBJECTDIR}/libyaxl/concurrency
	${RM} $@.d
	$(COMPILE.cc) -O2 -Isrc -std=c++11 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/libyaxl/concurrency/CachedCondition.o libyaxl/concurrency/CachedCondition.cpp
...
${OBJECTDIR}/libyaxl/concurrency/Thread.o: libyaxl/concurrency/Thread.cpp 
	${MKDIR} -p ${OBJECTDIR}/libyaxl/concurrency
	${RM} $@.d
	$(COMPILE.cc) -O2 -Isrc -std=c++11 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/libyaxl/concurrency/Thread.o libyaxl/concurrency/Thread.cpp

${OBJECTDIR}/libyaxl/examples/examples.o: libyaxl/examples/examples.cpp 
	${MKDIR} -p ${OBJECTDIR}/libyaxl/examples
	${RM} $@.d
	$(COMPILE.cc) -O2 -Isrc -std=c++11 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/libyaxl/examples/examples.o libyaxl/examples/examples.cpp

${OBJECTDIR}/libyaxl/file/WinFileImpl.o: libyaxl/file/WinFileImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/libyaxl/file
	${RM} $@.d
	$(COMPILE.cc) -O2 -Isrc -std=c++11 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/libyaxl/file/WinFileImpl.o libyaxl/file/WinFileImpl.cpp

${OBJECTDIR}/libyaxl/file/AbstractFile.o: libyaxl/file/AbstractFile.cpp 
	${MKDIR} -p ${OBJECTDIR}/libyaxl/file
	${RM} $@.d
	$(COMPILE.cc) -O2 -Isrc -std=c++11 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/libyaxl/file/AbstractFile.o libyaxl/file/AbstractFile.cpp

${OBJECTDIR}/libyaxl/sockets/ServerSocket.o: libyaxl/sockets/ServerSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/libyaxl/sockets
	${RM} $@.d
	$(COMPILE.cc) -O2 -Isrc -std=c++11 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/libyaxl/sockets/ServerSocket.o libyaxl/sockets/ServerSocket.cpp

${OBJECTDIR}/libyaxl/file/PosixFileImpl.o: libyaxl/file/PosixFileImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/libyaxl/file
	${RM} $@.d
	$(COMPILE.cc) -O2 -Isrc -std=c++11 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/libyaxl/file/PosixFileImpl.o libyaxl/file/PosixFileImpl.cpp

${OBJECTDIR}/libyaxl/concurrency/Stack.o: libyaxl/concurrency/Stack.cpp 
	${MKDIR} -p ${OBJECTDIR}/libyaxl/concurrency
	${RM} $@.d
	$(COMPILE.cc) -O2 -Isrc -std=c++11 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/libyaxl/concurrency/Stack.o libyaxl/concurrency/Stack.cpp
