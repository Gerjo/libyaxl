...
${OBJECTDIR}/src/file/AbstractFile.o: src/file/AbstractFile.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/file
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/file/AbstractFile.o src/file/AbstractFile.cpp
...
${OBJECTDIR}/src/sockets/OutputStream.o: src/sockets/OutputStream.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/sockets
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sockets/OutputStream.o src/sockets/OutputStream.cpp
